...
public class Builder
{
    ...
    public static Process createProcess(String file)
	    throws CreateModelException, JSONException, ClassNotFoundException,
    ...
    public static RandomValue createRandomValue(String file)
	    throws JSONException, InstantiationException,
	    IllegalAccessException, CreateModelException,
	...
	randomValue.restore(getParamsMap(jsonObj
	        .getJSONObject("randomValueParams")));
	return randomValue;
    }

    public static double[] createVector(String file)
    ...
    public static double[][] createMatrix(String file)
	    throws CreateModelException
    {
    ...
    private static HashMap<String, String> getParamsMap(JSONObject obj)
